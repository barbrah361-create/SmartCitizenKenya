  ...
  seed() {
    ...
    this.data.services = [
      ...
      },
      {
        ...
        image: "https://images.unsplash.com/photo-1505784043824-aa970094ee9b?auto=format&fit=crop&q=80&w=600",
        icon: "Baby",
...
app.post("/api/services", authenticateToken, (req: any, res) => {
  ...
  const newService = {
    ...
    name,
    description,
    image: image || "https://images.unsplash.com/photo-1600132806370-bf17e65e942f?auto=format&fit=crop&q=80&w=600",
    icon: icon || "Briefcase",
    department,
